...
var CasbinExclude = []UrlInfo{
	...
	{Url: "/api/v1/mall/dict-data/option-select", Method: "GET"},
	...
	{Url: "/api/v1/wc/admin/vendors/select", Method: "GET"},
	{Url: "/api/v1/pc/category/list/:id", Method: "GET"},
	{Url: "/api/v1/wc/stock-location-goods/location-list", Method: "GET"},
}
