...
var AuthChinese = map[string]string{
	"incorrect Username or Password": "用户名或密码错误",
	"secret key is required":         "密钥必填",
	"ErrMissingLoginValues":          "参数错误",
}
...
func Authenticator(c *gin.Context) (interface{}, error) {
	...
	if err != nil {
		...
		return nil, errors.New(AuthChinese[jwt.ErrFailedAuthentication.Error()])
	}
...
func LoginLogToDB(c *gin.Context, status string, msg string, username string) {
	...
	message, err := sdk.Runtime.GetStreamMessage("", global.AdminLoginLog, l)
	if err != nil {
