...
const (
	LogTypeOrderInfoUpdateInfo       = "updateInfo"
	LogTypeOrderInfoUpdateShipping   = "updateShipping"
	LogTypeOrderInfoUpdateProduct    = "updateProduct"
	LogTypeOrderInfoReceipt          = "receipt"
	LogTypeOrderInfoReceiptImageSave = "receiptImageSave"
	LogTypeOrderInfoAutoReceipt      = "autoReceipt" // 自动签收
	LogTypeOrderInfoCancel           = "cancel"
	LogTypeOrderInfoConfirm          = "confirm"
	LogTypeOrderInfoDelete           = "delete"
)
...
func (OrderInfoLog) TableName() string {
	return "order_info_log"
}

func (e *OrderInfoLog) GetId() interface{} {
	return e.Id
}

func (e *OrderInfoLog) BeforeCreate(tx *gorm.DB) (err error) {
	if e.AfterData == "" {
		e.AfterData = "{}"
	}
	if e.Data == "" {
...
func (e *OrderInfoLog) CreateLog(modelName string, tx *gorm.DB) error {
	logType := LogTypes{}
