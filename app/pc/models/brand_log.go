...
func (BrandLog) TableName() string {
	return "brand_log"
}

func (e *BrandLog) Generate() models.ActiveRecord {
	o := *e
	return &o
}

func (e *BrandLog) GetId() interface{} {
	return e.Id
}

func (e *BrandLog) BeforeCreate(tx *gorm.DB) (err error) {
	if e.AfterData == "" {
		e.AfterData = "{}"
	}
	if e.Data == "" {
...
func (e *BrandLog) CreateLog(modelName string, tx *gorm.DB) error {
	logType := LogTypes{}
