...
func (e *CategoryLog) Generate() models.ActiveRecord {
	o := *e
	return &o
}

func (e *CategoryLog) GetId() interface{} {
	return e.Id
}

func (e *CategoryLog) BeforeCreate(tx *gorm.DB) (err error) {
	if e.AfterData == "" {
		e.AfterData = "{}"
	}
	if e.Data == "" {
...
func (e *CategoryLog) CreateLog(modelName string, tx *gorm.DB) error {
	logType := LogTypes{}
